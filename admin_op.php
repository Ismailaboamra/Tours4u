...
{	
	$afname1=$_POST['afname11'];
	$apass1=$_POST['apass11'];
	$afname=$_POST['afname12'];
	$apass=$_POST['apass12'];
	$aemail=$_POST['aemail12'];
	$aphone=$_POST['aphone12'];
	$acity=$_POST['acity12'];
	//UPDATE `travel_agent` SET `afname`='$afname',`apass`='$apass',`aemail`='$aemail',`aphone`='$aphone',`acity`='$acity' WHERE afname='$afname1' and apass='$apass1'
	$sql1="UPDATE `travel_agent` SET `afname`='$afname',`apass`='$apass',`aemail`='$aemail',`aphone`='$aphone',`acity`='$acity' WHERE afname='$afname1' and apass='$apass1'";
	$result = mysqli_query($con,$sql1);
	header('location:guide.php');
}
?>